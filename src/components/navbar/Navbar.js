          ...
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                Hey! I have done my MCA from KIET group of institutions, Ghaziabad with overall Percentage of 67. My area of expertise is in Python programming. I've solved Data Structures and Algorithms problems on LeetCode and CodeChef, demonstrating my dedication to mastering problem-solving skills. I'm passionate about Full Stack development, and built some impactful projects using the MERN stack. Eager to leverage my expertise and contribute effectively to relevant endeavors..
                </p>
              </div>
